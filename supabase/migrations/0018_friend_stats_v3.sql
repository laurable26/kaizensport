-- =====================================================================
-- Migration 0018 : Ajoute total_time_s aux stats muscu des amis
-- Aligne les données de la fonction get_friend_stats avec le dashboard
-- personnel qui affiche maintenant le temps total en heures.
...
BEGIN
  ...
  -- Stats musculation (inclut total_time_s = durée cumulée de toutes les séances)
